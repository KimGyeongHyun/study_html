...
export default function Header() {
	// body 구성
	// title 을 누를 경우 날짜 버튼이 있는 DayList.tsx element 로 설정
	// 단어 추가 버튼을 누를 경우 단어를 생성하는 form 태그로 설정 (CreateWord.tsx)
	// Day 추가 버튼을 누를 경우 날짜를 생성하는 CreateDay.tsx element 로 설정
